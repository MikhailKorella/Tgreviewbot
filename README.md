...
Теперь после запуска кода и команды start в чате бот успешно заработает и будет запрашивать данные для их записи в таблицу. 
В данном примере кода будет 3 этапа:
1) Команда /start, появится клавиатура, необходимо выбрать категорию отзыва
2) Далее в зависимости от категории нужно выбрать подкатегорию вашего отзыва
3) После бот запросит сам текст отзыва, ограничивающийся лишь лимитом символов в Telegram и сохранит его в таблицу
